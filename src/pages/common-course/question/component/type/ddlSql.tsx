...
const DDLSql = forwardRef((props: IProps, ref) => {
  ...
  */
    ...
    */
    ...
    // 选中的场景id
    const [selectSceneId, setselectSceneId] = useState<number>();
    //场景表切换
    const handleChange = (value: string, option: React.ReactElement) => {
                ...
                <div className='card-content'>
                    ...
                    >
                        ...
                        <Form.Item label="题目场景" name="sceneId">
                            <Select placeholder="请选择" allowClear style={{ maxWidth: '200px' }} onChange={handleChange}>
                                {
                        ...
                        <Form.Item label="校验设置">
                            <Verify selectSceneId={selectSceneId} onInit={onInit} />
                        </Form.Item>
                        <Form.Item
                            label="题目描述"
                            name="stemEditor"
