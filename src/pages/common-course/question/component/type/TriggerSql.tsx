...
const TriggerSql = forwardRef((props: IProps, ref) => {
    ...
    */
    ...
    const testRunClick = async () => {
        ...
        if (values) {
            ...
            setLoading(true);
            const result = await testRunAnswer({ sceneId: values.sceneId ? values.sceneId : -1, exerciseId: exerciseId, standardAnswer: values.standardAnswser, exerciseType: 10, verySql: values.verySql });
